...
namespace Andora\Components {
    ...
    class InputEMail extends \XYO\Web\Component
    {
        public $form = null;
        public $name = null;
        public $legend = null;
        ...
        {
            $this->loadLanguageFromPath("./_site/andora/components", "input-email");
            ...
            <fieldset class="fieldset w-full">
                ...
                <input type="email" name="<?php echo $this->name; ?>" class="input validator w-full" <?php echo $attribute; ?>
                    placeholder="<?php echo $this->placeholder; ?>" <?php
                       echo $required;
                       echo " ";
                       echo $autocomplete;
                       ?> minlength="2" maxlength="64" id="<?php echo $this->id; ?>" value="<?php echo $this->value; ?>" />
                <p class="validator-hint hidden">
                    <?php $this->language->render("enter-valid-email-address"); ?>
                </p>
            </fieldset>
