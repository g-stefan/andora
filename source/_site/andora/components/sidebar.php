...
namespace Andora\Components {
    ...
    require_once("./_site/andora/components/sidebar-header.php");
    require_once("./_site/andora/components/sidebar-user.php");
    require_once("./_site/andora/models/sidebar.php");
    ...
    class Sidebar extends \XYO\Web\Component
    {
        ...
        public function init($options = null)
        {
            ...
            if (is_null($this->options)) {
                $this->options = \Andora\Models\Sidebar::getMenu();
            }
