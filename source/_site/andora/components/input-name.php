...
namespace Andora\Components {
    ...
    class InputName extends \XYO\Web\Component
    {
        public $form = null;
        public $name = null;
        public $legend = null;
        ...
        {
            $this->loadLanguageFromPath("./_site/andora/components", "input-name");
            ...
            <fieldset class="fieldset w-full">
                ...
                <p class="validator-hint hidden">
                    <?php $this->language->render("required-must-be-2-to-64-characters"); ?>
                </p>
            </fieldset>
