...
messageAction("vendor xyo.web.library");

vendor =  "xyo.web.library-" + Solution.vendor["xyo.web.library"];
...
var webLink = vendorSourceGit + "/xyo.web.library/releases/download/v" + Solution.vendor["xyo.web.library"] + "/" + vendor + ".7z";
