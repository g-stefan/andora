...
messageAction("vendor xyo.web");

vendor =  "xyo.web-" + Solution.vendor["xyo.web"];
...
var webLink = vendorSourceGit + "/xyo.web/releases/download/v" + Solution.vendor["xyo.web"] + "/" + vendor + ".7z";
